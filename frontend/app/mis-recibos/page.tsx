...
export default function MisRecibos() {
  ...
  if (!token) return <main className="min-h-screen bg-[#0d1117] p-12 text-white">Cargando sesión…</main>
  if (loading && recibos.length === 0) return <main className="min-h-screen bg-[#0d1117] p-12 text-white">Cargando recibos…</main>

  return (
    <main className="min-h-screen bg-[#0d1117] px-6 py-8 text-white lg:px-10">
      <div className="mx-auto max-w-7xl">
        <header className="mb-8 rounded-2xl border border-white/10 bg-white/5 p-6 shadow-[0_20px_80px_rgba(0,0,0,0.25)]">
          <p className="text-[10px] font-semibold uppercase tracking-[0.32em] text-[#70e9d2]">Mi cuenta</p>
          <div className="mt-3 flex flex-col gap-4 md:flex-row md:items-end md:justify-between">
            <div>
              <h1 className="font-serif text-4xl text-white md:text-5xl">Mis recibos</h1>
            </div>
            <a href="/" className="inline-flex items-center gap-2 rounded-full border border-white/10 bg-white/5 px-4 py-2 text-[10px] font-semibold uppercase tracking-[0.2em] text-white/70">
              Inicio
            </a>
          </div>
        </header>
        ...
        <section className="mb-10 overflow-hidden rounded-2xl border border-white/10 bg-[#111827] shadow-[0_20px_80px_rgba(0,0,0,0.2)]">
          <div className="flex items-center gap-3 border-b border-white/10 p-5">
            <div className="rounded-lg bg-[#70e9d2]/10 p-2 text-[#70e9d2]">
              <CreditCard size={18} />
            </div>
        ...
        <section className="overflow-hidden rounded-2xl border border-white/10 bg-[#111827] shadow-[0_20px_80px_rgba(0,0,0,0.2)]">
          <div className="flex items-center gap-3 border-b border-white/10 p-5">
            <div className="rounded-lg bg-[#70e9d2]/10 p-2 text-[#70e9d2]">
              <Landmark size={18} />
            </div>
      ...
      {openPay && pagoData && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-[#0d1117]/80 p-5 backdrop-blur-sm">
          <div role="dialog" aria-modal="true" className="w-full max-w-md rounded-2xl border border-white/10 bg-[#111827] p-8 shadow-[0_30px_100px_rgba(0,0,0,0.4)]">
