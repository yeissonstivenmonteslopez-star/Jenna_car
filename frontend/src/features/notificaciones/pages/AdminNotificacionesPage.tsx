...
import { getAdminUsuarios } from '@/features/usuarios/services/usuariosService'
import { getAdminNotificaciones, createAdminNotificacion } from '@/features/notificaciones/services/notificacionesService'
...
export default function AdminNotificacionesPage() {
  ...
  const fetchDatos = useCallback(async () => {
    ...
    try {
      const data = await getAdminNotificaciones({ no_leidas: !verTodas }, token)
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      await createAdminNotificacion(payload, token)
